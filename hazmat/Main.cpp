...
//   to protect you from hazardous name conflicts
//
...
int main(int argc, char* argv[]) {
    if (argc < 4) {
        cerr << "usage: hazmat /IN:LibraryName.lib /OUT:QuarantinedLib.lib /NEST:ABC "
             << "/X:SymbolExcludeMatch,Symbol2ExcludeMatch,...,SymbolNExcludeMatch" << endl;
        return EXIT_FAILURE;
    }
